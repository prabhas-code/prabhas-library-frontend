...
import AuthorLayout from "./pages/Author/AuthorLayout"; // ✅ import layout
...
function AppRoutes() {
  ...
  // ✅ Author routes (inside AuthorLayout)
  if (user?.role === "author") {
    return (
      <Routes>
        <Route
        ...
        >
          ...
          {/* <Route path="/mybooks" element={<AuthorBooks />} /> */}
        </Route>

        {/* Redirect any unknown author routes */}
